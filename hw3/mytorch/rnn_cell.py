...
class RNNCell(object):
    ...
    def forward(self, x, h):
        ...
        """
        # some parameters need to be transposed
        # this implementation equals to the equation 1 in writeup transposed
    ...
    def backward(self, delta, h, h_prev_l, h_prev_t):
        ...
        # 2) Compute dx, dh
        dx = np.dot(self.W_ih.T, dz.T).T
        dh = np.dot(self.W_hh.T, dz.T).T
